...
describe('model catalog labels', () => {
  it('builds the matrix without opening native menus', () => {
    const labels = labelsFromModelCatalog([
      { displayName: '5.6 Sol', defaultReasoningEffort: 'medium', supportedReasoningEfforts: ['low', 'medium', 'high', 'xhigh', 'ultra'], serviceTiers: [{ id: 'priority', name: 'Fast' }] },
      { displayName: '5.6 Luna', defaultReasoningEffort: 'medium', supportedReasoningEfforts: ['low', 'medium', 'high', 'xhigh'], serviceTiers: [] },
    ], 'fr-FR')
